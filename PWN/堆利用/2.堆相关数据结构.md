...
* 每个bin由bin数组中的两个值表示。第一个是指向'HEAD'的指针，第二个是指向bin列表的'TAIL'的指针。在fastbin（单链表）的情况下，第二个值是NULL![image-20240911145835315](.img/2.堆相关数据结构.assets/image-20240911145835315.png)
