...
```
patchelf --set-interpreter /home/ubuntu/tools/glibc-all-in-one/libs/2.31-0ubuntu9_amd64/ld-2.31.so file_path
更换glibc搜索路径：
patchelf --set-rpath /home/ubuntu/tools/glibc-all-in-one/libs/2.31-0ubuntu9_amd64 file_path
或直接更换动态库：
patchelf --replace-needed libc.so.6 /home/ubuntu/tools/glibc-all-in-one/libs/2.31-0ubuntu9_amd64/libc.so.6 file_path
